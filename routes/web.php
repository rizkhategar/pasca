...
use App\Http\Controllers\SintaLecturerReadOnlyFetchMonitorController;
...
Route::get('/scrap/sinta-fetch-batches/status', [SintaLecturerReadOnlyFetchMonitorController::class, 'status'])->name('scrap.sintaFetchBatches.status');
...
Route::get('/scrap/sinta-fetch-batches/study-program-settings', [SintaLecturerReadOnlyFetchMonitorController::class, 'studyProgramSettings'])->name('scrap.sintaFetchBatches.studyProgramSettings');
