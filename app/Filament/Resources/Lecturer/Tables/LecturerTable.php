...
namespace App\Filament\Resources\Lecturer\Tables;
...
class LecturerTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ViewAction::make()
                    ->url(fn ($record) => LecturerResource::getUrl('view', ['record' => $record])),

                EditAction::make()
                    ->url(fn ($record) => LecturerResource::getUrl('edit', ['record' => $record])),
