...
namespace App\Filament\Resources\UndergraduateLecturer\Schemas;
            ...
            ->components([
                ...
                Select::make('department')
                    ...
                    ->afterStateHydrated(function (Select $component, $record) {
                        ...
                        $undergraduateLecturer = UndergraduateLecturer::where('sinta_id', $record->sinta_id)->first();
                        ...
                        $associatedPrograms = DB::table('undergraduate_lecturer_study_programs')
                            ->where('undergraduate_lecturer_id', $undergraduateLecturer->id)
                    ...
                    ->saveRelationshipsUsing(function ($record, $state) {
                        ...
                        DB::table('undergraduate_lecturer_study_programs')
                            ->where('undergraduate_lecturer_id', $undergraduateLecturer->id)
                            ->delete();
                        ...
                        if (! empty($state)) {
                            $pivotData = collect($state)
                                ...
                                ->unique()
                                ->map(function ($studyProgramId) use ($undergraduateLecturer) {
                                    return [
                            ...
                            if (! empty($pivotData)) {
                                DB::table('undergraduate_lecturer_study_programs')->insert($pivotData);
                            }
                        }
                    })
                    ->dehydrated(false)
