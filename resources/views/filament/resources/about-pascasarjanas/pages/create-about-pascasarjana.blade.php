<x-filament-panels::page>
    ...
    <form action="{{ route('admin.about-pascasarjanas.store') }}" method="POST" enctype="multipart/form-data" class="custom-filament-form">
        ...
        <div class="custom-form-card">
            ...
            <p class="custom-section-desc">Atur sub-judul, judul, dan deskripsi utama profil.</p>
            <div class="custom-form-grid">
                <div class="custom-two">
                    <div class="custom-field">
                        <label for="subheading">Sub Judul</label>
                        <input type="text" id="subheading" name="subheading" value="{{ old('subheading', 'Tentang Kami') }}" required>
                    </div>
                    <div class="custom-field">
                        <label for="heading">Judul Utama</label>
                        <input type="text" id="heading" name="heading" value="{{ old('heading') }}" placeholder="Cth: Mewujudkan Generasi Unggul" required>
                    </div>
                </div>
                <div class="custom-field">
        ...
        @php($oldPoints = old('points', [['title' => '', 'description' => ''], ['title' => '', 'description' => ''], ['title' => '', 'description' => '']]))
        <div class="custom-form-card">
                ...
                @foreach ($oldPoints as $index => $point)
                    <div class="custom-point" data-point>
                        ...
                        <div class="custom-field">
                            ...
                            <p class="custom-help">Gunakan JPG, PNG, WEBP, atau SVG. Maksimal 5 MB.</p>
                        </div>
                        <div class="custom-two">
                            <div class="custom-field">
            ...
            <div class="custom-form-grid">
                <div class="custom-two">
                    <div class="custom-field">
                        ...
                        <input type="text" id="direktur_heading" name="direktur_heading" value="{{ old('direktur_heading', 'Sambutan Direktur') }}">
                    </div>
                    <div class="custom-field">
                        <label for="direktur_greeting">Kalimat Sapaan</label>
                        <input type="text" id="direktur_greeting" name="direktur_greeting" value="{{ old('direktur_greeting', 'Selamat Datang di Pascasarjana Universitas Ngudi Waluyo') }}">
                    </div>
                </div>
                <div class="custom-field">
                    <label for="direktur_image">Foto Direktur</label>
                    <input type="file" id="direktur_image" name="direktur_image" accept="image/jpeg,image/png,image/webp">
                    <p class="custom-help">Upload langsung seperti Organization Structures. Maksimal 5 MB.</p>
                </div>
                <div class="custom-two">
                    <div class="custom-field">
                        <label for="direktur_name">Nama Lengkap</label>
                        <input type="text" id="direktur_name" name="direktur_name" value="{{ old('direktur_name') }}">
                    </div>
                    <div class="custom-field">
                        <label for="direktur_title">Jabatan</label>
                        <input type="text" id="direktur_title" name="direktur_title" value="{{ old('direktur_title', 'Direktur Pascasarjana Universitas Ngudi Waluyo') }}">
                    </div>
                </div>
                <div class="custom-field">
                    <label for="direktur_message">Isi Pesan / Sambutan</label>
                    <textarea id="direktur_message" name="direktur_message" rows="7">{{ old('direktur_message') }}</textarea>
        ...
        <div class="custom-actions">
            <button type="submit" class="custom-btn-primary">Save About Pascasarjana</button>
